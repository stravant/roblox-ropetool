...
if COMBINE_TOOLBAR then
	...
	local toolbar = plugin:CreateToolbar("RopeTool")
	local button = toolbar:CreateButton("openRopeTool", TOOLTIP, RIBBON_ICON, "RopeTool")
...
local panel = plugin:CreateDockWidgetPluginGuiAsync("RopeToolPanel", params)
